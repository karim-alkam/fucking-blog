      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="text-center lg:text-left order-1 flex flex-col items-center lg:items-start">
            ...
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-display font-bold mb-8 leading-none tracking-tighter text-white uppercase glitch relative" data-text="WELCOME TO THE GRID">
